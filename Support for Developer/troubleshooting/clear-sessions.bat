@echo off
REM Script untuk clear semua session dan cache Laravel
REM Gunakan script ini ketika berpindah dari localhost:8000 ke virtual host atau sebaliknya

echo.
echo Clearing Laravel sessions and cache...
echo.

REM Clear session dari database

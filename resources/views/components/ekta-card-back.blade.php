...
<style>
    .ekta-card-back {
        ...
        border-radius: 14px;
        box-shadow: 0 14px 30px rgba(61, 28, 28, .15);
    ...
    .ekta-card-back__pattern {
        background-image: radial-gradient(circle, rgba(128, 0, 0, .06) 1px, transparent 1.4px);
    ...
    .ekta-card-back__content {
        position: relative;
        z-index: 1;
    }

    .ekta-card-back__header {
        border-bottom: 2px solid #600000;
        margin-bottom: 7px;
        padding-bottom: 5px;
    }

    .ekta-card-back__title {
        color: #600000;
        font-size: 11px;
        font-weight: 800;
        letter-spacing: .05em;
    ...
    .ekta-card-back__rules li {
        margin-bottom: 2px;
    }

    .ekta-card-back__motto-box {
        background: rgba(96, 0, 0, .04);
        border-left: 3px solid #f2ce45;
        margin-top: 5px;
        padding: 3px 7px;
    }

    .ekta-card-back__motto {
        color: #600000;
        font-size: 7.5px;
        font-style: italic;
        font-weight: 700;
    ...
    .ekta-card-back__signature strong {
        color: #600000;
        display: block;
    }

    .ekta-card-back__signature small {
        color: #725c75;
        display: block;
        margin-bottom: 15px;
    }

    .ekta-card-back__line {
        background: #600000;
        bottom: 0;
        height: 5px;
        left: 0;
